...
public class MedGotocart extends AppCompatActivity {
    Button btncheckout, btndate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gotocart_med);
        //getSupportActionBar().hide();

        database mydb = new database(getApplicationContext(),"mydb",null,1);

        btndate = findViewById(R.id.buttonmeddate);
        btncheckout = findViewById(R.id.buttonmedcheckout);
        //btntime = findViewById(R.id.buttonmedtime);
       // btnback = findViewById(R.id.buttonmedback);
        total = findViewById(R.id.textViewmed3);
        ...
        ArrayList cartdata = mydb.getdata(Email,"medicine");
        ...
        /*btncheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MedGotocart.this,MedCheckout.class);
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MedGotocart.this, Medicine.class);
                startActivity(intent);
            }
        });
